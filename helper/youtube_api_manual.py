...
api_key: str = 'AIzaSyAsDcKOenYw7VK_FgdKK6xliT2k136X3DM'#os.getenv('YT_API_KEY') не работает, не разобраться пока
...
channel_id = 'UCUQCJV9ksyRXe0sCH5noWNg'  # HighLoad Channel
